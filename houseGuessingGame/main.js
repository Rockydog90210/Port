...
function imgFun() {
	episodeImg = randomValueFromArray(imgArray);
	if (episodeImg == 'img1.png') {
		document.getElementById('housePNG').src = "img1.png";
	} else if (episodeImg == 'img2.png') {
		document.getElementById('housePNG').src = "img2.png";
	}
